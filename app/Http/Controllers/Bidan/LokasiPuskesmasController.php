...
class LokasiPuskesmasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.bidan.lokasipuskesmas.index', [
            'items' => $items
        ]);
    }
    ...
    {
        // return view('pages.bidan.lokasipuskesmas.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.bidan.lokasipuskesmas.detail', [
            'item' => $item
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        // return view('pages.bidan.lokasipuskesmas.edit', [
        //     'item' => $item
        // ]);
    }
