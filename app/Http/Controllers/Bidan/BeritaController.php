...
class BeritaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.bidan.berita.index', [
            'items' => $items
        ]);
    }
    ...
    {
        // return view('pages.bidan.berita.create');
    }
    ...
    public function show($judul)
    {
        ...
        return view('pages.bidan.berita.detail',[
            'item' => $item
        ]);
    }
    ...
    public function edit($judul)
    {
        ...
        // return view('pages.bidan.berita.edit', [
        //     'item' => $item
        // ]);
    }
