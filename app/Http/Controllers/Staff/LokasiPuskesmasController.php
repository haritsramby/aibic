...
class LokasiPuskesmasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.staff.lokasipuskesmas.index', [
            'items' => $items
        ]);
    }
    ...
    {
        // return view('pages.staff.lokasipuskesmas.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.staff.lokasipuskesmas.detail', [
            'item' => $item
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        // return view('pages.staff.lokasipuskesmas.edit', [
        //     'item' => $item
        // ]);
    }
