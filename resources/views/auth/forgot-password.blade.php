...
<head>
    ...
    <title>Forgot Password &mdash; AIBIC</title>
    <!-- General CSS Files -->
            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        ...
                        <h4 class="text-center text-dark font-weight-normal">Lupa Password?
                            {{-- <span class="font-weight-bold">AIBIC</span> --}}
                        </h4>
                        <p class="text-center text-muted">We will send a link to reset your password</p>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-lg btn-block" tabindex="4">Forgot Password
                                </button>
                            </div>
                        </form>
                    </div>
