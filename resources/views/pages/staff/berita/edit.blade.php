...
<section class="section">
    ...
    <div class="section-body">
        ...
        <p class="section-lead">Di halaman ini Anda dapat mengupdate postingan dan mengisi semua kolom.</p>
    </div>
    <div class="card card-primary">
        <div class="card-body">
            ...
            @endif
            <form method="POST" action="{{ route('berita.update', $item->id) }}">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label class="font-weight-bold" for="judul">Judul Berita<span class="text-danger">*</span></label>
                    <input id="judul" type="text" value="{{ $item->judul }}" class="form-control" name="judul" required>
                </div>
                <div class="form-group">
                    <label class="font-weight-bold" for="headline">Headline<span class="text-danger">*</span></label>
                    <input id="headline" type="text" value="{{ $item->headline }}" class="form-control" name="headline" required>
                ...
                <div class="form-group">
                    ...
                    <input id="kategori" type="text" value="{{ $item->kategori }}" class="form-control" name="kategori" required>
                </div>
                {{-- <div class="form-group">
                    <label class="font-weight-bold" for="thumbnail">Thumbnail</label>
                    <div class="custom-file">
                        <input type="file" class="form-input" name="thumbnail" id="thumbnail">
                        <label class="form-input" for="thumbnail"></label>
                    </div>
                </div> --}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12 col-md-7">
                      <textarea class="summernote-simple" id="summernote" name="isi_berita">{!!htmlspecialchars_decode($item->isi_berita)!!}</textarea>
                    </div>
                </div>
