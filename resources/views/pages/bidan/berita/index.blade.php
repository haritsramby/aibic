...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      <div class="breadcrumb-item active"><a href="{{ route('bidan')}}">Dashboard</a></div>
      ...
      <article class="article article-style-b">
        ...
        <div class="article-details">
          <div class="article-title">
            <h2><a href="{{route('berita-bidan.show', $item->judul)}}">{{ substr(strip_tags(htmlspecialchars_decode($item->judul)), 0, 30) }}...</a></h2>
          ...
          <div class="article-cta">
            <a href="{{route('berita-bidan.show', $item->judul)}}">Read More <i class="fas fa-chevron-right"></i></a>
          </div>
        </div>
      </article>
    </div>
