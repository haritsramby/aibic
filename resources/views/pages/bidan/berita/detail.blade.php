@extends('layouts.bidan.dashboard')
...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="/bidan/berita">Berita</a></div>
    ...
    <article class="article article-style-c">
        ...
        <div class="d-flex">
            <div class="d-flex flex-grow-1 align-items-center">
                <a href="{{route('berita-bidan.index')}}" class="btn btn-primary mr-2" aria-haspopup="true" aria-expanded="false">Kembali</a>
                {{-- <a href="{{route('berita.edit', $item->judul)}}" class="btn btn-warning" aria-haspopup="true" aria-expanded="false">Edit</a> --}}
            </div>
            {{-- <div class="p-2">
                <form class="pull-right" action="{{route('berita.destroy', $item->id)}}" method="POST" class="d-inline">
                    @csrf
                    @method('delete')
