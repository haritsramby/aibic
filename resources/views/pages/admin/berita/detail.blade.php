...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="/admin/berita">Berita</a></div>
    ...
    <article class="article article-style-c">
        ...
        <div class="d-flex">
            <div class="d-flex flex-grow-1 align-items-center">
                <a href="{{route('berita.index')}}" class="btn btn-primary mr-2" aria-haspopup="true" aria-expanded="false">Kembali</a>
